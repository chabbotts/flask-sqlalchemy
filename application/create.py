...
from application.models import Person, Car, Hobby
...
#
# cars = [car1, car2, car3]
# car4 = Car(number_plate='BART21', person_id=3, colour='Yellow', make="Ferrari", model='V12')
# car5 = Car(number_plate='CRET22', person_id=4, colour='Red', make='BMW', model='C11')

hobby1 = Hobby(hobbyName='singing', description='using your voice nicely', person_id=3)
